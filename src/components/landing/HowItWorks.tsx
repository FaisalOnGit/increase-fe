  ...
  const steps = [
    {
      ...
      title: "Buat Akun",
      description:
        "Daftar dalam hitungan menit untuk mulai menggunakan platform.",
      emoji: "👤",
    ...
    },
    {
      ...
      title: "Review Kampus",
      description:
        "Proposal akan ditinjau sebelum dikirim ke tingkat nasional.",
      emoji: "📋",
    ...
    <section className="py-20 bg-gradient-to-b from-background to-amber-50/30">
      <div className="container mx-auto px-10">
        <div className="text-center mb-16">
          <h2 className="text-4xl font-bold mb-4">Alur Pengajuan PKM</h2>
            ...
            <div key={step.number} className="relative">
              <div className="bg-white rounded-3xl p-6 shadow-lg hover:shadow-xl transition-all duration-300 border-2 border-transparent hover:border-amber-200 h-full">
                ...
                <div className="relative mb-4">
                  <div
                    className={`absolute inset-0 bg-gradient-to-br ${step.color} opacity-10 rounded-2xl blur-xl`}
                  ></div>
                  <div
                    className={`relative size-16 rounded-2xl bg-gradient-to-br ${step.color} flex items-center justify-center text-3xl`}
                  >
                    {step.emoji}
                  </div>
                </div>
